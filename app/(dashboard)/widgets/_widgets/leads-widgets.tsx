...
import { OpenTodosWidgetClient } from "./open-todos-widget-client";
...
export function OpenTodosWidget({ data }: { data: DashboardData }) {
  // Interaktiver Personen-Filter (Default „Meine") läuft in der Client-Komponente.
  return (
    <OpenTodosWidgetClient
      items={data.openTodoItems}
      people={data.todoPeople}
